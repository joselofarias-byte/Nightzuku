...
```
content://com.joselofarias.nightzuku.connector
```
...
```kotlin
val uri = Uri.parse("content://com.joselofarias.nightzuku.connector")
...
```bash
OUTPUT=$(content query --uri content://com.joselofarias.nightzuku.connector)
